...
For detailed type definitions, refer to the library's [TypeScript Definitions](https://github.com/NLJinchuriki/supra-starkey-connect/blob/master/packages/supra-starkey-connect/lib/types.ts).
