...
const App: React.FC = () => {
  ...
  const connectWallet = async () => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'Connection Attempt: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
    ...
    try {
      ...
      fetchAllAccounts(ssc)
      fetchBalance(ssc)
      fetchVersion(ssc)
      fetchChainId(ssc)
      fetchCurrentNetwork(ssc)
    } catch (err: any) {
  ...
  const disconnectWallet = async () => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'Disconnection Attempt: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
  ...
  const sendTransaction = async () => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'sendTransaction Attempt: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
  ...
  const handleSignMessage = async () => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'Sign message failed: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
  ...
  const handleSignAndSendTransaction = async () => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'Sign and Send Transaction failed: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
    ...
    try {
      ...
      if (txHash) {
        ...
        addLog(
          `Using waitForTransactionCompletion to check status of transfer with hash ${txHash}`
        )
  ...
  const changeNet = async (chain: string) => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'Change network failed: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
  ...
  const promptInstall = () => {
    if (!ssc) {
      setStatus('SupraStarkeyConnect instance not initialized.')
      addLog(
        'Prompt Install failed: SupraStarkeyConnect instance not initialized.'
      )
      return
    }
   ...
   * @param {ReturnType<typeof getSupraStarkeyConnect>} ssc - The SupraStarkeyConnect instance.
   */
  const fetchAllAccounts = async (
    ssc: ReturnType<typeof getSupraStarkeyConnect>
  ) => {
    if (!ssc) return
    try {
